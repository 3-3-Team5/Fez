...
public class UVCube : MonoBehaviour
{
    ...
    public void ApplyTexture()
    {
        ...
        /*
                ...
                uvs[2] = new Vector2(0f, 0.75f); //Top Left
                uvs[3] = new Vector2(30f / 192f, 0.75f); // Top Right

                // Right
                uvs[20] = new Vector2(31f / 192f, 0f);
                uvs[22] = new Vector2(54f / 192f, 0f);
                uvs[23] = new Vector2(31f / 192f, 0.75f);
                uvs[21] = new Vector2(54f / 192f, 0.75f);


                // Back
                uvs[10] = new Vector2(55f / 192f, 0.75f);
                uvs[11] = new Vector2(85f / 192f, 0.75f);
                uvs[6] = new Vector2(55f / 192f, 0f);
                uvs[7] = new Vector2(85f / 192f, 0f);

                // Left
                uvs[16] = new Vector2(86f / 192f, 0f);
                uvs[18] = new Vector2(110f / 192f, 0f);
                uvs[19] = new Vector2(86f / 192f, 0.75f);
                uvs[17] = new Vector2(110f / 192f, 0.75f);

                // Up
                uvs[8] = new Vector2(111f / 192f, 0f);
                uvs[9] = new Vector2(139f / 192f, 0f);
                uvs[4] = new Vector2(111f / 192f, 0.75f);
                uvs[5] = new Vector2(139f / 192f, 0.75f);


                // Down
                uvs[12] = new Vector2(140f / 192f, 0f);
                uvs[14] = new Vector2(168f / 192f, 0f);
                uvs[15] = new Vector2(140f / 192f, 0.75f);
                uvs[13] = new Vector2(168f / 192f, 0.75f);
                mesh.uv = uvs;
